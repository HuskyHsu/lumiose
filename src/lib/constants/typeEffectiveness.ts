...
export type PokemonType = keyof typeof TYPE_EFFECTIVENESS_CHART;
export type TypeEffectivenessChart = typeof TYPE_EFFECTIVENESS_CHART;
export type EffectivenessMultiplier = 0 | 0.25 | 0.5 | 1 | 2 | 4;

/**
 * Common effectiveness multipliers used in the weakness display
 */
export const WEAKNESS_MULTIPLIERS: EffectivenessMultiplier[] = [4, 2, 0.5, 0.25, 0];
